...
- [Protected replay history](protected-replay-history.md) - Protect long global rebuilds with durable renewable retention leases and short one-stream repairs with transaction-scoped history guards.
